...
function LightHero() {
  ...
  return (
    <motion.section
      ...
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#F5EDE4]"
    >
      {/* Subtle grid */}
      <div 
...
function ServicesSection() {
  return (
    <section id="services" className="py-32 bg-[#F5EDE4]">
...
function Footer() {
  return (
    <footer className="py-8 px-6 bg-[#F5EDE4] border-t border-gray-100">
