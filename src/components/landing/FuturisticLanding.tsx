...
const woodButtonClass = "text-white font-semibold rounded-xl px-8 py-4 shadow-lg hover:shadow-xl transition-all hover:brightness-90 border-b-2 border-[#7a5c38]";
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#FBF9F6]/90 backdrop-blur-md border-b border-[#EDE8E1]'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2.5">
          ...
          <span className="text-2xl font-extrabold text-[#3D2E1C] tracking-tight">vantix<span className="text-[#8B6D47]">.</span></span>
        </a>
        <div className="hidden md:flex items-center gap-8">
          {links.map((l) => (
            <a key={l.href} href={l.href} className="text-sm text-[#A39484] hover:text-[#3D2E1C] transition-colors">
              {l.label}
            </a>
          ))}
          <a
        ...
        <button className="md:hidden text-[#3D2E1C]" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Toggle menu">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#FBF9F6]/95 backdrop-blur-md border-b border-[#EDE8E1] overflow-hidden"
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              {links.map((l) => (
                <a key={l.href} href={l.href} onClick={() => setMobileOpen(false)} className="text-[#A39484] hover:text-[#3D2E1C] transition-colors">
                  {l.label}
                </a>
              ))}
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed top-0 left-0 right-0 z-[60] bg-white/90 backdrop-blur-md border-b border-[#EDE8E1]"
        >
          <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            <span className="text-[#3D2E1C]/80 text-sm font-medium hidden sm:block">Ready to automate?</span>
            <a
              href="#booking"
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute inset-0"
        style={{
          background: 'linear-gradient(to bottom, rgba(251,249,246,0.6) 0%, rgba(251,249,246,0.95) 100%)',
        }}
      />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-6 text-center pt-20">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#EDE8E1] bg-white mb-8 shadow-sm"
        >
          <span className="w-2 h-2 rounded-full bg-[#8B6D47] animate-pulse" />
          <span className="text-sm text-[#A39484] font-medium">2 Humans + 2 AI Assistants — Building 24/7</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-[-0.03em] text-[#3D2E1C] leading-[0.93] mb-8"
        >
          Your Competitors Are
          <br />
          Automating. <span className="text-[#8B6D47]">Are You?</span>
        </motion.h1>
        ...
        >
          <p className="text-base sm:text-lg text-[#A39484] max-w-2xl mx-auto leading-relaxed">
            <span>{typedText}</span>
            <span className="inline-block w-0.5 h-5 bg-[#8B6D47] ml-1 animate-pulse" />
          </p>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-sm text-[#8B6D47]/70 mt-8 font-medium"
        >
...
function AnimatedCounterSection() {
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]" ref={ref}>
        ...
        >
          {metrics.map((m, i) => (
            <motion.div key={i} variants={popIn} className="flex flex-col items-center">
              <span className="text-3xl md:text-5xl font-bold text-[#8B6D47] tabular-nums">{m.value}</span>
              <span className="text-sm text-[#A39484] mt-1">{m.label}</span>
            </motion.div>
          ))}
        </motion.div>
      </div>
    ...
    <section className="py-24 lg:py-32 relative" ref={ref}>
      <div className="max-w-5xl mx-auto px-6 relative">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-[#3D2E1C]">
            See the Difference
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          <div className="flex justify-center mb-10">
            <button
              ...
              className="relative flex items-center bg-white rounded-full p-1.5 shadow-sm border border-[#EDE8E1]"
            >
              <span className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all ${!showAfter ? 'bg-[#3D2E1C] text-white' : 'text-[#A39484]'}`}>
                Before
              </span>
              <span className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all ${showAfter ? 'text-white' : 'text-[#A39484]'}`} {...(showAfter ? woodButtonProps() : {})}>
                After Vantix
              </span>
            </button>
          </div>
            ...
            <AnimatePresence mode="wait">
              {!showAfter ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -30 }}
                  className="md:col-span-2 p-10 rounded-xl bg-white shadow-sm border border-[#EDE8E1]"
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-3 h-3 rounded-full bg-[#C5C3BE]" />
                    <span className="text-[#A39484] font-semibold text-sm uppercase tracking-wider">Without AI Automation</span>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-6">
                    {before.map((item, i) => (
                      <div key={i} className="flex items-center gap-3 p-4 rounded-xl bg-[#F7F4F0]">
                        <X size={18} className="text-[#C5C3BE] shrink-0" />
                        <span className="text-[#A39484] font-medium">{item}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  exit={{ opacity: 0, x: 30 }}
                  className="md:col-span-2 p-10 rounded-xl bg-white shadow-sm border border-[#8B6D47]/20"
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-3 h-3 rounded-full bg-[#8B6D47]" />
                    <span className="text-[#8B6D47] font-semibold text-sm uppercase tracking-wider">With Vantix AI</span>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-6">
                    {after.map((item, i) => (
                      <div key={i} className="flex items-center gap-3 p-4 rounded-xl bg-[#8B6D47]/5">
                        <CheckCircle2 size={18} className="text-[#8B6D47] shrink-0" />
                        <span className="text-[#3D2E1C] font-medium">{item}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
...
function ProblemSection() {
  ...
  return (
    <section className="py-24 lg:py-32 relative bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
      <div className="max-w-7xl mx-auto px-6 relative" ref={ref}>
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-[#3D2E1C] leading-tight max-w-3xl mx-auto">
        ...
        >
          <motion.div variants={fadeLeft} className="relative p-10 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1]">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-3 h-3 rounded-full bg-[#C5C3BE]" />
              <span className="text-[#A39484] font-semibold text-sm uppercase tracking-wider">Before Vantix</span>
            </div>
            <ul className="space-y-4">
              {before.map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-[#A39484] text-base leading-relaxed">
          ...
          <motion.div variants={fadeRight} className="relative p-10 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#8B6D47]/20">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-3 h-3 rounded-full bg-[#8B6D47]" />
              <span className="text-[#8B6D47] font-semibold text-sm uppercase tracking-wider">After Vantix</span>
            </div>
            <ul className="space-y-4">
              {after.map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-[#3D2E1C] text-base leading-relaxed">
                  <CheckCircle2 size={16} className="text-[#8B6D47] mt-1 shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
    ...
    <section id="services" className="py-24 lg:py-32 relative">
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-[#3D2E1C] leading-tight">
            AI That Runs Your Business.<br />Not Just Advises On It.
          </motion.h2>
          <motion.p variants={fadeUp} className="text-[#A39484] text-base leading-relaxed mt-4 max-w-2xl mx-auto">
        ...
        >
          {services.map((s, i) => (
            <motion.div
              key={i}
              variants={scaleUp}
              className="group relative p-10 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1] hover:border-[#8B6D47]/20 cursor-default"
            >
              <div className="w-12 h-12 rounded-xl bg-[#F7F4F0] flex items-center justify-center mb-5 group-hover:bg-[#8B6D47]/10 transition-colors">
                <s.icon size={22} className="text-[#8B6D47]" />
              </div>
              <h3 className="text-[#3D2E1C] font-semibold text-lg mb-2">{s.title}</h3>
              <p className="text-[#A39484] text-sm leading-relaxed">{s.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
...
function TechStackSection() {
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
      <div className="max-w-5xl mx-auto px-6 relative">
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {techs.map((tech, i) => (
            <motion.div
              ...
              className="px-6 py-4 rounded-xl bg-white shadow-sm border border-[#EDE8E1] text-[#3D2E1C] font-semibold text-sm"
            >
              {tech}
            </motion.div>
          ))}
    ...
    <section className="py-24 lg:py-32 relative">
      <div className="max-w-7xl mx-auto px-6 relative">
        <motion.div
          ...
          variants={staggerContainer}
        >
          <motion.p variants={fadeUp} className="text-sm font-semibold uppercase tracking-widest text-[#8B6D47] mb-4 text-center">
            Featured Work
          </motion.p>
          <motion.div
            variants={fadeUp}
            className="relative p-8 md:p-12 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#8B6D47]/15 overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#8B6D47]/5 rounded-full blur-3xl" />
            <div className="relative grid md:grid-cols-2 gap-10 items-center">
              <motion.div variants={fadeLeft}>
                <h3 className="text-2xl md:text-3xl font-bold text-[#3D2E1C] mb-2">Secured Tampa</h3>
                <p className="text-[#8B6D47] text-sm font-medium mb-6">
                  From Instagram DMs to a 122-page e-commerce empire — in 3 weeks.
                </p>
                <p className="text-[#A39484] text-base leading-relaxed mb-6">
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  {['E-Commerce', 'POS Integration', 'AI Automation', 'Custom Platform'].map((tag) => (
                    <span key={tag} className="px-4 py-1.5 rounded-full border border-[#8B6D47]/20 bg-[#8B6D47]/5 text-[#8B6D47] text-xs font-medium">
                      {tag}
                    </span>
                  ))}
                </div>
                <a
                  ...
                  className="group inline-flex items-center gap-2 text-[#8B6D47] font-semibold hover:text-[#6b5535] transition-colors"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    variants={popIn}
                    className="p-5 rounded-xl bg-[#F7F4F0] shadow-sm text-center"
                  >
                    <div className="text-2xl font-bold text-[#8B6D47]">{m.value}</div>
                    <div className="text-xs text-[#A39484] mt-1">{m.label}</div>
                  </motion.div>
                ))}
              </div>
            </div>
...
function ProcessTimeline() {
  ...
  return (
    <section id="process" className="py-24 lg:py-32 relative bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
      <div className="max-w-4xl mx-auto px-6 relative">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#8B6D47]/30 to-transparent md:-translate-x-px" />
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <motion.div
                variants={popIn}
                className="absolute left-6 md:left-1/2 w-3 h-3 rounded-full bg-[#8B6D47] border-4 border-white shadow-md -translate-x-1.5 md:-translate-x-1.5 mt-6 z-10"
              />
              ...
              <div className={`ml-12 md:ml-0 md:w-1/2 ${!isMobile ? (i % 2 === 0 ? 'md:pr-12' : 'md:pl-12') : ''}`}>
                <div className="p-8 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1]">
                  <div className={`flex items-center gap-3 mb-3 ${!isMobile && i % 2 === 0 ? 'md:justify-end' : ''}`}>
                    <div className="w-10 h-10 rounded-xl bg-[#8B6D47]/10 flex items-center justify-center">
                      <step.icon size={18} className="text-[#8B6D47]" />
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-[#3D2E1C]">{step.title}</h3>
                      <span className="text-xs text-[#8B6D47] font-medium">{step.timeline}</span>
                    </div>
                  </div>
                  <p className="text-[#A39484] text-sm leading-relaxed">{step.desc}</p>
                </div>
              </div>
    ...
    <section className="py-24 lg:py-32 relative">
      <div className="max-w-4xl mx-auto px-6 relative">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-[#3D2E1C] mb-12">
            Don&apos;t Take Our Word For It
          </motion.h2>
          <motion.div
            variants={scaleUp}
            className="relative p-10 md:p-14 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1]"
          >
            {/* Quotation mark */}
            <div className="text-[#8B6D47]/10 text-8xl font-serif leading-none mb-2 select-none">&ldquo;</div>

            {/* Stars */}
            <div className="flex justify-center gap-1 mb-6">
              {[...Array(5)].map((_, i) => (
                <Star key={i} size={20} className="text-[#8B6D47] fill-[#8B6D47]" />
              ))}
            </div>

            <blockquote className="text-xl md:text-2xl text-[#3D2E1C] font-medium leading-relaxed mb-8">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                <p className="text-[#3D2E1C] font-semibold">Dave</p>
                <p className="text-[#A39484] text-sm">Founder, SecuredTampa</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
...
function ROISection() {
  ...
  return (
    <section id="roi" className="py-24 lg:py-32 relative bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
      <div className="max-w-7xl mx-auto px-6 relative">
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          {stats.map((s, i) => (
            <motion.div
              key={i}
              variants={popIn}
              className="text-center p-10 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1]"
            >
              <s.icon size={28} className="text-[#8B6D47] mx-auto mb-4" />
              <div className="text-3xl md:text-4xl font-bold text-[#8B6D47] mb-1">{s.value}</div>
              <div className="text-sm text-[#A39484]">{s.label}</div>
            </motion.div>
          ))}
        </motion.div>
      </div>
        ...
        >
          {team.map((t, i) => (
            <motion.div
              ...
              className="p-10 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-[#EDE8E1] text-center"
            >
              <div className="w-28 h-28 rounded-full mx-auto mb-6 overflow-hidden shadow-sm border-2 border-white/80">
                <img src={t.photo} alt={t.name} className="w-full h-full object-cover" />
              </div>
              <h3 className="text-xl font-bold text-[#3D2E1C]">{t.name}</h3>
              <p className="text-[#8B6D47] text-sm font-medium mb-4">{t.role}</p>
              <p className="text-[#A39484] text-sm leading-relaxed">{t.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
...
function FAQItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="rounded-xl bg-white shadow-sm border border-[#EDE8E1] overflow-hidden">
      <button
        onClick={() => setOpen(!open)}
        className="w-full flex items-center justify-between p-6 text-left hover:bg-[#F5F1EC] transition-colors"
      >
        <span className="text-[#3D2E1C] font-medium pr-4">{q}</span>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <p className="px-6 pb-6 text-[#A39484] leading-relaxed">{a}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 lg:py-32 relative bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
...
function ContactForm() {
  ...
  if (status === 'sent') {
    return (
      <div id="contact-form" className="max-w-lg mx-auto mt-12 bg-white rounded-xl p-8 shadow-sm text-center">
        <CheckCircle2 size={48} className="mx-auto mb-4 text-[#8B6D47]" />
        <h3 className="text-xl font-bold text-[#3D2E1C] mb-2">You&apos;re In.</h3>
        <p className="text-[#A39484]">We&apos;ll reach out within 24 hours with next steps. Check your inbox.</p>
      </div>
    );
  }
  ...
  return (
    <form id="contact-form" onSubmit={handleSubmit} className="max-w-lg mx-auto mt-12 bg-white rounded-xl p-8 shadow-sm">
      <p className="text-center text-[#A39484] text-sm mb-6">Prefer to type? Drop us a message and we&apos;ll follow up within 24 hours.</p>
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-[#3D2E1C] mb-1.5">Name *</label>
          <input type="text" required value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} placeholder="Your name" className="w-full px-4 py-3 rounded-xl border border-[#EDE8E1] bg-[#FBF9F6] text-[#3D2E1C] placeholder-[#C5C3BE] focus:outline-none focus:border-[#8B6D47] focus:ring-1 focus:ring-[#8B6D47]/30 transition-all" />
        </div>
        <div>
          <label className="block text-sm font-medium text-[#3D2E1C] mb-1.5">Email *</label>
          <input type="email" required value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))} placeholder="you@company.com" className="w-full px-4 py-3 rounded-xl border border-[#EDE8E1] bg-[#FBF9F6] text-[#3D2E1C] placeholder-[#C5C3BE] focus:outline-none focus:border-[#8B6D47] focus:ring-1 focus:ring-[#8B6D47]/30 transition-all" />
        </div>
        <div>
          <label className="block text-sm font-medium text-[#3D2E1C] mb-1.5">Phone <span className="text-[#C5C3BE]">(optional)</span></label>
          <input type="tel" value={form.phone} onChange={e => setForm(p => ({ ...p, phone: e.target.value }))} placeholder="(555) 123-4567" className="w-full px-4 py-3 rounded-xl border border-[#EDE8E1] bg-[#FBF9F6] text-[#3D2E1C] placeholder-[#C5C3BE] focus:outline-none focus:border-[#8B6D47] focus:ring-1 focus:ring-[#8B6D47]/30 transition-all" />
        </div>
        <div>
          <label className="block text-sm font-medium text-[#3D2E1C] mb-1.5">What&apos;s eating your time?</label>
          <textarea value={form.message} onChange={e => setForm(p => ({ ...p, message: e.target.value }))} rows={4} placeholder="Tell us about the manual tasks, bottlenecks, or goals you want AI to tackle..." className="w-full px-4 py-3 rounded-xl border border-[#EDE8E1] bg-[#FBF9F6] text-[#3D2E1C] placeholder-[#C5C3BE] focus:outline-none focus:border-[#8B6D47] focus:ring-1 focus:ring-[#8B6D47]/30 transition-all resize-none" />
        </div>
        <button
          type="submit"
...
function FinalCTA() {
  return (
    <section id="contact" className="py-24 lg:py-32 relative overflow-hidden bg-white rounded-xl mx-4 lg:mx-0 shadow-sm border border-[#EDE8E1]">
      <div className="max-w-4xl mx-auto px-6 text-center relative">
        <motion.div
          ...
          variants={staggerContainer}
        >
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#3D2E1C] leading-tight mb-6">
            Every Day You Wait,
            <br />
            <span className="text-[#8B6D47]">Your Competitors Pull Ahead.</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-[#A39484] text-base leading-relaxed max-w-2xl mx-auto mb-4">
          ...
          <motion.p variants={fadeUp} className="text-[#3D2E1C] font-semibold text-lg mb-10">
            <a href="tel:9084987753" className="hover:text-[#8B6D47] transition-colors inline-flex items-center gap-2">
              <Phone size={18} />
              (908) 498-7753
            </a>
          </motion.p>
          ...
          <motion.p variants={fadeUp} className="text-[#8B6D47]/60 text-sm mt-6 font-medium">
...
function Footer() {
  return (
    <footer className="py-16 bg-[#3D2E1C] text-white mt-4">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-14">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center text-white font-extrabold text-sm" {...woodButtonProps()}>V</div>
              <span className="text-2xl font-extrabold text-white tracking-tight">vantix<span className="text-[#8B6D47]">.</span></span>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              {[
                ...
                <a key={i} href={s.href} className="text-white/40 hover:text-[#8B6D47] transition-colors">
                  <s.icon size={18} />
                </a>
              ))}
            </div>
...
export function FuturisticLanding() {
  ...
  return (
    <div className="bg-[#FBF9F6] text-[#3D2E1C] min-h-screen selection:bg-[#8B6D47]/20 selection:text-[#3D2E1C] scroll-smooth">
      <Navigation />
      <StickyCTABar />
      <HeroSection />
