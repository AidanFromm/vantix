...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5EDE4] text-[#2C1810] scroll-smooth">
      <nav className="sticky top-0 z-50 bg-[#F5EDE4]/90 backdrop-blur-md border-b border-[#E8D8CA]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-lg font-bold tracking-tight hover:text-[#8B5E3C] transition-colors">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        <motion.p initial="hidden" animate="visible" variants={fadeUp} className="text-[#8B5E3C] text-sm font-semibold uppercase tracking-widest mb-4">
          Let&apos;s Talk
        </motion.p>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
            className="lg:col-span-3 rounded-2xl p-8 bg-white border border-[#E8D8CA] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff]">
            {submitted ? (
              <div className="text-center py-12">
                <CheckCircle2 className="w-12 h-12 text-[#8B5E3C] mx-auto mb-4" />
                <h3 className="text-2xl font-bold mb-2">You&apos;re In.</h3>
                <p className="text-[#9C8575] mb-2">We&apos;ll respond within 24 hours with next steps.</p>
                <p className="text-[#9C8575] text-sm">Check your inbox — or book a call below for faster turnaround.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                <p className="text-sm text-[#9C8575] mb-2">Takes 60 seconds. No commitment required.</p>
                <div>
                  <label className="block text-sm font-medium mb-2">Name *</label>
                  <input
                    required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
                    className="w-full px-4 py-3 rounded-xl bg-[#F5EDE4] border border-[#E8D8CA] shadow-[inset_3px_3px_6px_#d1cdc7,inset_-3px_-3px_6px_#ffffff] focus:outline-none focus:ring-2 focus:ring-[#8B5E3C]/30 focus:border-[#8B5E3C] transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#F5EDE4] border border-[#E8D8CA] shadow-[inset_3px_3px_6px_#d1cdc7,inset_-3px_-3px_6px_#ffffff] focus:outline-none focus:ring-2 focus:ring-[#8B5E3C]/30 focus:border-[#8B5E3C] transition-all resize-none"
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <div className="rounded-2xl p-6 bg-white border border-[#E8D8CA] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff]">
              <h3 className="font-bold mb-4">Direct Line</h3>
              <div className="space-y-4">
                <a href="tel:+19084987753" className="flex items-center gap-3 text-sm text-[#5C5650] hover:text-[#8B5E3C] transition-colors">
                  <Phone className="w-4 h-4 text-[#8B5E3C]" /> (908) 498-7753
                </a>
                <a href="mailto:hello@usevantix.com" className="flex items-center gap-3 text-sm text-[#5C5650] hover:text-[#8B5E3C] transition-colors">
                  <Mail className="w-4 h-4 text-[#8B5E3C]" /> hello@usevantix.com
                </a>
              </div>
            </div>
            <div className="rounded-2xl p-6 bg-white border border-[#E8D8CA] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff]">
              <h3 className="font-bold mb-3">Skip the Form — Book a Call</h3>
              <p className="text-sm text-[#9C8575] mb-4">30-minute free AI audit. We&apos;ll map your automation opportunities and show you projected ROI.</p>
              <a
                href="/#booking"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full px-6 py-3 rounded-full border border-[#E8D8CA] text-sm font-semibold shadow-[4px_4px_10px_#d1cdc7,-4px_-4px_10px_#ffffff] hover:shadow-[6px_6px_14px_#c8c4be,-6px_-6px_14px_#ffffff] hover:border-[#8B5E3C]/20 transition-all"
              >
                <Calendar className="w-4 h-4 text-[#8B5E3C]" /> Open Cal.com
              </a>
            </div>
            <div className="rounded-2xl p-6 bg-white border border-[#E8D8CA] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff]">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={step.text} className="flex items-start gap-3 text-sm text-[#5C5650]">
                    <step.icon className="w-4 h-4 text-[#8B5E3C] mt-0.5 shrink-0" />
                    <span>{step.text}</span>
                  </div>
                ))}
              </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          ...
          <p className="text-[#9C8575] text-center mb-6">Pick a time below. 30 minutes. Zero pressure. All value.</p>
          <div className="rounded-2xl overflow-hidden border border-[#E8D8CA] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff]">
            <iframe
