        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          {team.map((m, i) => (
            <motion.div key={m.name} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              className="rounded-2xl p-8 bg-white border border-[#D8CFC4] shadow-[8px_8px_20px_#d1cdc7,-8px_-8px_20px_#ffffff] hover:border-[#9B6C3C]/20 transition-all">
              <div className="w-14 h-14 rounded-xl bg-[#F5EFE7] shadow-[inset_4px_4px_8px_#d1cdc7,inset_-4px_-4px_8px_#ffffff] flex items-center justify-center mb-5">
                <m.icon className="w-7 h-7 text-[#9B6C3C]" />
              </div>
              <h3 className="text-xl font-bold">{m.name}</h3>
              <p className="text-sm text-[#9B6C3C] font-medium mb-3">{m.role}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-left">
              <div className="w-14 h-14 rounded-xl bg-[#F5EFE7] shadow-[inset_4px_4px_8px_#d1cdc7,inset_-4px_-4px_8px_#ffffff] flex items-center justify-center mb-5 mx-auto md:mx-0">
                <Bot className="w-7 h-7 text-[#9B6C3C]" />
              </div>
              <h3 className="text-xl font-bold mb-2">The AI Team Members</h3>
              <p className="text-[#9B6C3C] text-sm font-medium mb-4">The Half That Never Sleeps</p>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {values.map((v, i) => (
            <motion.div key={v.title} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              className="rounded-2xl p-6 bg-white border border-[#D8CFC4] shadow-[6px_6px_16px_#d1cdc7,-6px_-6px_16px_#ffffff] hover:border-[#9B6C3C]/20 transition-all">
              <v.icon className="w-6 h-6 text-[#9B6C3C] mb-3" />
