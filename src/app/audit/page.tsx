    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          {/* Left - Info */}
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#10b981]/10 text-[#10b981] text-sm mb-6">
              <Search size={14} />
              Free Website Audit
            </div>
            <h1 className="text-4xl font-bold mb-6">
              Get a Free<br />
              <span className="text-[#10b981]">Website Audit</span>
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg focus:outline-none focus:border-[#10b981] transition-colors"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-[#10b981] text-white font-medium rounded-lg hover:bg-[#0d9668] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
