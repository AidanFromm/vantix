        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((s, i) => (
            ...
            >
              ...
              <Link href="/#booking" className="group inline-flex items-center gap-1.5 text-sm font-semibold bg-[#B07A45] hover:bg-[#8E5E34] text-white px-5 py-2.5 rounded-xl transition-colors">
